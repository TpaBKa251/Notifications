...
import static ru.tpu.hostel.notifications.common.logging.Message.FINISH_SERVICE_METHOD_EXECUTION;
import static ru.tpu.hostel.notifications.common.logging.Message.FINISH_SERVICE_METHOD_EXECUTION_WITH_RESULT;
import static ru.tpu.hostel.notifications.common.logging.Message.SERVICE_METHOD_EXECUTION_EXCEPTION;
import static ru.tpu.hostel.notifications.common.logging.Message.START_SERVICE_METHOD_EXECUTION;
import static ru.tpu.hostel.notifications.common.logging.Message.START_SERVICE_METHOD_EXECUTION_WITH_PARAMETERS;
import static ru.tpu.hostel.notifications.common.utils.TimeUtil.getLocalDateTimeStingFromMillis;
...
public class ServiceLoggingFilter {
    ...
    @Around("execution(public * ru.tpu.hostel.notifications.service..*(..)) && !execution(* *..ApplicationRunner.*(..))")
